...
public class TestDFS {
	...
	assertTrue(list.indexOf(dg.getNodeFor(i[3])) < list.indexOf(dg
		.getNodeFor(i[4])));
	assertTrue(list.indexOf(dg.getNodeFor(i[4])) < list.indexOf(dg
		.getNodeFor(i[5])));
	...
	assertTrue(list.get(6) == dg.getNodeFor(i[11])
		|| list.get(6) == dg.getNodeFor(i[12]));
	...
	assertSame(list.get(0), dg.getNodeFor(i[10]));
	assertTrue(list.get(6) == dg.getNodeFor(i[15])
		|| list.get(6) == dg.getNodeFor(i[16]));
	...
	assertTrue(list.get(5) == dg.getNodeFor(i[1])
		|| list.get(5) == dg.getNodeFor(i[2]));
	assertTrue(list.get(0) == dg.getNodeFor(i[5])
		|| list.get(0) == dg.getNodeFor(i[6])
		|| list.get(0) == dg.getNodeFor(i[1]));
	assertTrue(list.get(4) == dg.getNodeFor(i[3])
		|| list.get(4) == dg.getNodeFor(i[1]));
	...
	assertTrue(list.get(5) == dg.getNodeFor(i[11])
		|| list.get(5) == dg.getNodeFor(i[12]));
	assertTrue(list.get(0) == dg.getNodeFor(i[15])
		|| list.get(0) == dg.getNodeFor(i[16]));
	assertSame(list.get(3), dg.getNodeFor(i[13]));
